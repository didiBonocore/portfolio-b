const navigation = {
  ...
  social: [
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/barbara-alencar-pacheco-6b7759156/',
      icon: (props) => (
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/ba.alencarpacheco/',
      icon: (props) => (
    ...
    {
      name: 'Youtube',
      href: 'https://www.youtube.com/c/BarbaraAlencarPacheco',
      icon: (props) => (
  ...
  return (
    <footer className="bg-gray-50">
      ...
      <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
        ...
        <p className="mt-8 text-center text-base text-gray-400">{date} All rights reserved.</p>
      </div>
    </footer>
  )
}
